...
import olaf1 from '../public/olaf1.png'
...
export default function Politiker({backgrounds, setBackgrounds, currentPicture, setCurrentPicture, background, setCurrentBackground}) {
    ...
    const [politiker, setPolitiker] = useState([lindner2, olaf1, fritz1, lindner1, annalena1, habeck2, habeck1, tom1, boeri1])
    ...
    return (
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center h-10 mb-5 z-50">
            <div>
        ...
        <div className="w-full md:w-1/2 3xl:w-1/3 h-96 relative overflow-hidden ">
            ...
            {background && <Image src={background} layout="fill" objectFit='cover' className="z-0 absolute bottom-0 " />}
            {currentPicture && <Image src={currentPicture} layout="fill" objectFit='cover' className="z-20 absolute bottom-0" />}
            <TextComponent textBackground={textBackground} topText={topText} textFarbe={textFarbe} />
